...
<div class="mainbody">
    ...
    <div class="bigcontainer">
        <div class="left630">
            ...
            <div class="loginBox">
                <form method="post" id="resetPwdForm"  action="<?php echo U('Login/resetPwd');?>" jump-url="<?php echo U('Index/index');?>">
                    <ul class="login">
                        ...
                        <li><label>验证码：</label><input class="loginValue" name="captcha" id="captcha">
                            <img id="captchaimg" src="<?php echo U('Login/showVerify');?>">
                            <a href="#" onclick="$('#captchaimg').attr('src', '<?php echo U('Login/showVerify');?>?t='+Math.random())">看不清？</a></li>
                        <li style="margin-bottom:15px;"><label>&nbsp;</label><input type="submit" value="找回密码" class="tijiao" style="border:0;"></li>
                        <li><label>&nbsp;</label>已有账号&nbsp;<a href="<?php echo U('Login/index');?>">登录</a><span>没有<?php echo ((isset($config["name"]) && ($config["name"] !== ""))?($config["name"]):'本网站'); ?>账号？&nbsp;<a href="<?php echo U('Reg/reg');?>" class="zhuce">注册一个</a></span></li>
                    </ul>
