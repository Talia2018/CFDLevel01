...
<!--	<main>-->
	...
	<div class="autobox">
    <div class="now"> <a href="<?php echo U('Index/index');?>" class="orange">首页</a> &gt;<a href="<?php echo U('Dow/index');?>" class="orange"> 下载中心 </a> &gt; 新币上线申请 </div>
    ...
    <div class="assets_center clear po_re zin70">
        ...
        <div style="top: -1px;" class="coin_menu">
            <div class="coin_menu_box">
                <dl>
                    <dt><a href="<?php echo U('Dow/index');?>">虚拟币钱包下载</a></dt>
          <dt><a href="<?php echo U('Dow/two');?>">浏览器下载</a></dt>
          <dt  class="here"><a href="<?php echo U('Dow/newcoin');?>">新币上线申请</a></dt>
                </dl>
            </div>
        </div>
        <style>
        ...
        <div class="assets_content w753 right bg_w">
            ...
            <div class="xj">
                <span style="text-indent: 2em;"><?php echo ($config["new_coin_up"]); ?>
                <a href="<?php echo ($config["biaoge_url"]); ?>" style="padding:13px 20px;clear:both;margin:20px 0 0 30px;  display: inline-block;background-color: #e55600;color:#fff;border-radius: 300px;;" target="_blank">下载新币上线申请表</a>
            </div>
        </div>
    </div>
</div>	
