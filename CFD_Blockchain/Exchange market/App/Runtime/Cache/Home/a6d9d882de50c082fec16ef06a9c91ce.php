...
<div class="ybc_list">
                ...
                <div class="ybcoin invitecon" style="margin-bottom:0;">
                    <h2>复制以下内容发送给你的好友<span style="margin-left:20px;color:red;">您的邀请码是: <?php echo (session('USER_KEY_ID')); ?></span></h2>
                    <div>
                        <div class="left invitelink">
                            <textarea name="url" id="url">http://<?php echo ($_SERVER['SERVER_NAME']); echo U('Reg/reg',array('Member_id'=>session('USER_KEY_ID')));?></textarea>
                            <input type="hidden" value="<?php echo (session('USER_KEY_ID')); ?>" id="user_key_id">
                            <input type="hidden" value="<?php echo ($_SERVER['SERVER_NAME']); ?>" id="server_name">
                        </div>
...
<script>window._bd_share_config={"common":{"bdUrl":"http://"+$("#server_name").val()+"/Home/Reg/reg/Member_id/"+$("#user_key_id").val()+".html","bdSnsKey":{},"bdText":"","bdMini":"2","bdPic":"","bdStyle":"0","bdSize":"16"},"share":{},"image":{"viewList":["qzone","tsina","tqq","renren","weixin"],"viewText":"分享到：","viewSize":"16"},"selectShare":{"bdContainerClass":null,"bdSelectMiniList":["qzone","tsina","tqq","renren","weixin"]}};with(document)0[(getElementsByTagName('head')[0]||body).appendChild(createElement('script')).src='http://bdimg.share.baidu.com/static/api/js/share.js?v=89860593.js?cdnversion='+~(-new Date()/36e5)];</script>
                ...
                <div class="ybcoin invitecon">
                    <h2><?php echo ((isset($info["title"]) && ($info["title"] !== ""))?($info["title"]):"邀请规则"); ?></h2>
                    <ul class="rules">
                        <?php echo ($config["invite_rule"]); ?>
                        <div class="clear"></div>
                    </ul>
                </div>
            </div>
            <div class="ybc_list">
                    <div class="ybcoin">
                        <h2 class="left">我的邀请</h2><h2 class="right">邀请奖励总额: <span style="color:#f60;"><?php echo ((isset($count) && ($count !== ""))?($count):'0'); ?></span></h2>
                    </div>
