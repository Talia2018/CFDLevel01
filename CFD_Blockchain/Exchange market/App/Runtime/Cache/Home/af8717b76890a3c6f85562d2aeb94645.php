        ...
        <div class="newsarea_box">
            <div class="product left clearfix">
                <div style="border-bottom:1px solid #e2e2e2; padding-top:20px; position:relative;">
                    <h2 style="line-height:24px; border:none;">【<?php echo ($list['type_name']); ?>】<?php echo ($list['title']); ?></h2>
                    <p style=" position:absolute; right:40px; bottom:0px; color:#999;"><?php echo (date("Y-m-d H:i:s",$list['add_time'])); ?></p>
                </div>
                ...
                <div class="latest">
                    <div class="investmentarea">
                        <div class="focusnum1" style="border-bottom:1px solid #eee;">
                            ...
                            <p class="right"><a href="<?php echo U('User/sysMassage');?>">查看更多</a></p>
                            <div class="clear"></div>
                        </div>
                        <ul>
                            <?php if(is_array($right)): $i = 0; $__LIST__ = $right;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><a href="<?php echo U('User/showSysTem',array('message_id'=>$row['message_id'],'message_all_id'=>$row['message_all_id']));?>">
									<li>
										<p class="left" style="width:200px; line-height:18px;">【<?php echo ($row['type_name']); ?>】<?php echo ($row['title']); ?></p>
										<p class=" right recruit" style="width:65px; margin-left:0;"><?php echo (date("Y-m-d",$row['add_time'])); ?></p>
										<div class="clear"></div>
									</li>
