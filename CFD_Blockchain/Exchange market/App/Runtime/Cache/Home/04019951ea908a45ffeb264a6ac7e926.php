...
<div class="ybc_section">
    ...
    <form id="form" method="post"  jump-url="<?php echo U('Reg/regSuccess');?>"  action="<?php echo U('ModifyMember/modify');?>">
...
<script charset="utf-8" src="/Public/Home/js/kindeditor-min.js"></script>
