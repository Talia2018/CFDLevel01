...
<!--	<main>-->
	...
	<div class="autobox">
  <div class="now"> <a href="<?php echo U('Index/index');?>" class="orange">首页</a> &gt;<a href="<?php echo U('Dow/index');?>" class="orange"> 下载中心 </a> &gt; 浏览器下载 </div>
    ...
    <div class="assets_center clear po_re zin70">
        ...
        <div style="top: -1px;" class="coin_menu">
          ...
          <dt  class="here"><a href="<?php echo U('Dow/two');?>">浏览器下载</a></dt>
