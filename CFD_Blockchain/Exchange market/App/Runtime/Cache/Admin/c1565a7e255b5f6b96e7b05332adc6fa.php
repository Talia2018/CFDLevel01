...
<div class="main-wrap">
    <div class="crumb-wrap">
        <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo U('Index/index');?>">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">全站统计信息</span></div>
    </div>
        ...
        <div class="result-content">
            <table class="result-tab" width="100%">
                <tr>
                    ...
                    <td>众筹总数量</td>
                    <td><?php echo ((isset($issue_count['count']) && ($issue_count['count'] !== ""))?($issue_count['count']):'0'); ?></td>
                </tr>
                <tr>
                    <td>人民币收入</td>
                    <td>￥<?php echo (floatval((isset($pay_money_count) && ($pay_money_count !== ""))?($pay_money_count):'0')); ?></td>
                    <td>人民币支出</td>
                    <td>￥<?php echo (floatval((isset($withdraw_money_count) && ($withdraw_money_count !== ""))?($withdraw_money_count):'0')); ?></td>
                </tr>
                <tr>
                    <td>充值单数</td>
                    <td><?php echo ((isset($pay_count) && ($pay_count !== ""))?($pay_count):'0'); ?>单</td>
                    <td>提现单数</td>
                    <td><?php echo ((isset($withdraw_count) && ($withdraw_count !== ""))?($withdraw_count):'0'); ?>单</td>
                </tr>
            </table>
            <div class="result-title">
                <h1>全站币种统计</h1>
            ...
            <table class="result-tab" width="70%" style="text-align: center;margin-left: 130px;">
                ...
                <?php if(is_array($currency_u_info)): $i = 0; $__LIST__ = $currency_u_info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        <td><?php echo ($vo['currency_name']); ?></td>
                        <td><?php echo (floatval($vo['num'])); ?></td>
                        <td><?php echo (floatval($vo['forzen_num'])); ?></td>
                        <td><?php echo (floatval($vo['num']+$vo['forzen_num'])); ?></td>
