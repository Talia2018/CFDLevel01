            ...
            <div class="result-content">
                <table class="result-tab" width="100%">
                    ...
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td><?php echo ($vo['forzen_rmb']); ?></td>
                            <td><?php echo (date('Y-m-d H:i:s',$vo['reg_time'])); ?></td>
                            <td><?php if($vo['status'] == 1): ?>正常<?php endif; ?>
                                <?php if($vo['status'] == 2): ?>禁用<?php endif; ?>
                                <?php if($vo['status'] == 0): ?>未填写个人信息(<a href="<?php echo U('Member/saveModify',array('member_id'=>$vo['member_id']));?>">填写</a>)<?php endif; ?>
                                </td>
                            <td>
                                ...
                                <a class="link-update" href="<?php echo U('Member/show',array('member_id'=>$vo['member_id']));?>">查看会员账户</a>
                            </td>
