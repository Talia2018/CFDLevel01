...
$(".sidebar-list li").children("a").on("click",function(){
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo U('Index/index');?>">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">众筹管理</span></div>
        </div>
            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="<?php echo U('Zhongchou/add');?>"><i class="icon-font"></i>添加众筹</a>
                    </div>
                </div>
                    ...
                    <table class="result-tab" width="100%">
                         <tr>
                            ...
                            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                <td><?php echo ((isset($vo["id"]) && ($vo["id"] !== ""))?($vo["id"]):'0'); ?></td>
                                <td><?php echo ((isset($vo["title"]) && ($vo["title"] !== ""))?($vo["title"]):'0'); ?></td>
                                <td><?php echo ((isset($vo["name"]) && ($vo["name"] !== ""))?($vo["name"]):'0'); ?></td>
                                <td><?php echo (getCurrencynameByCurrency($vo["buy_currency_id"])); ?></td>
                                <td><?php echo ((isset($vo["num_nosell"]) && ($vo["num_nosell"] !== ""))?($vo["num_nosell"]):'0'); ?></td>
                                <td><?php echo ((isset($vo["num"]) && ($vo["num"] !== ""))?($vo["num"]):'0'); ?></td>
                                <td><?php echo ((isset($vo["deal"]) && ($vo["deal"] !== ""))?($vo["deal"]):'0'); ?></td>
                                <td><?php echo ((isset($vo["price"]) && ($vo["price"] !== ""))?($vo["price"]):'0'); ?></td>
                                <td><?php echo ((isset($vo["limit"]) && ($vo["limit"] !== ""))?($vo["limit"]):'0'); ?></td>
                                <td><?php echo ((isset($vo["zhongchou_success_bili"]) && ($vo["zhongchou_success_bili"] !== ""))?($vo["zhongchou_success_bili"]):'0'); ?>%</td>
                                <td><?php echo (date('Y-m-d H:i:s',$vo["add_time"])); ?></td>
                                <td><?php echo (date('Y-m-d H:i:s',$vo["end_time"])); ?></td>
                                <td><?php echo (zhongchouStatus($vo["status"])); ?></td>
                                <td><a href="<?php echo U('Zhongchou/add',array('id'=>$vo['id']));?>">修改</a> <a href="<?php echo U('Zhongchou/del',array('id'=>$vo['id']));?>">删除</a> <a href="<?php echo U('Zhongchou/zhongchouEnd',array('id'=>$vo['id']));?>">结束众筹</a>&nbsp;<a href="<?php echo U('Zhongchou/zhongchouStart',array('id'=>$vo['id']));?>">开启众筹</a>
                                <a href="<?php echo U('Zhongchou/awards',array('id'=>$vo['id']));?>">添加众筹推荐奖励</a></td>
                              </tr><?php endforeach; endif; else: echo "" ;endif; ?>
                            <tr>
                              <td colspan=12 class="page"><?php echo ($page); ?></td>
                            </tr>
                    </table>
                </div>
            </form>
