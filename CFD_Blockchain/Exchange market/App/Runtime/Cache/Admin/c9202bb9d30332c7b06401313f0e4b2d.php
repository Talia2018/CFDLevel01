...
$(".sidebar-list li").children("a").on("click",function(){
    ...
    <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo U('Index/index');?>">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">财务明细</span></div>
        </div>
        ...
        <div class="result-wrap">
             <table class="result-tab" width="100%">
                <tr>
                    <td>人工充值人民币总额</td>
                    <td><?php echo ((isset($pay) && ($pay !== ""))?($pay):'0.00'); ?></td>
                    <td>管理员充值人民币总额</td>
                    <td><?php echo ((isset($pay_admin) && ($pay_admin !== ""))?($pay_admin):'0.00'); ?></td>
                </tr>
                <tr>
                    <td>提现成功总额</td>
                    <td><?php echo ((isset($draw) && ($draw !== ""))?($draw):'0.00'); ?></td>
                    <td>会员持有人民币总额</td>
                    <td><?php echo ((isset($rmb) && ($rmb !== ""))?($rmb):'0.00'); ?></td>
                </tr>
                <?php if(is_array($currency_user)): $i = 0; $__LIST__ = $currency_user;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    <td>会员持<?php echo ((isset($vo["name"]) && ($vo["name"] !== ""))?($vo["name"]):'数字币'); ?>币可用总额</td>
                    <td><?php echo ((isset($vo["num"]) && ($vo["num"] !== ""))?($vo["num"]):'0.00'); ?></td>
                    <td>会员持<?php echo ((isset($vo["name"]) && ($vo["name"] !== ""))?($vo["name"]):'数字币'); ?>币冻结总额</td>
                    <td><?php echo ((isset($vo["forzen_num"]) && ($vo["forzen_num"] !== ""))?($vo["forzen_num"]):'0.00'); ?></td>
