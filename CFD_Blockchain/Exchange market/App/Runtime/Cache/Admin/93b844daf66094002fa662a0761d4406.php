...
$(".sidebar-list li").children("a").on("click",function(){
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo U('Index/index');?>">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">下载管理</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
               	<span class="crumb-name">下载管理</span><br><br><br>
                <form action="<?php echo U('Download/biaogeDownload');?>" method="post" enctype="multipart/form-data">
                  <table class="tablesty">
                    <tbody>
                      <tr>
                        ...
                        <td class="wid1 ceshi"><a href='<?php echo ($config["biaoge_url"]); ?>'>测试</a></td>
                      </tr>
                    </tbody>
                  </table>
               ...
               <br> <hr><br>
                <form action="<?php echo U('Download/qianbaoDownload');?>" method="post" enctype="multipart/form-data">
                  <table class="tablesty">
                    <tbody>
                      <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        <td class="wid1"><?php echo ($vo["currency_name"]); ?>钱包上传：</td>
                        <td class="wid2"><input type='file' name='<?php echo ($vo["currency_id"]); ?>'> </td>
                        <td class="wid1"><a href='<?php echo ($vo["qianbao_url"]); ?>'>测试钱包</a></td>
                ...
                <br> <hr><br>
                <form action="<?php echo U('Download/guanwangUrl');?>" method="post" enctype="multipart/form-data">
                  <table class="tablesty">
                    <tbody>
                      <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        <td class="wid1"><?php echo ($vo["currency_name"]); ?>官方网站： </td>
                        <td class="wid1"><input type="text" name="guanwang_url[<?php echo ($vo["currency_id"]); ?>]" value="<?php echo ($vo["guanwang_url"]); ?>"  style="width:300px;"/></td>
                        <input type="hidden" name="currency_id[]" value="<?php echo ($vo["currency_id"]); ?>" />
                      </tr><?php endforeach; endif; else: echo "" ;endif; ?>
                      <tr>
                        <td><input class="btn-primary" style=" width:60px;" type="submit" value="提交"></td>
                      </tr>
