...
$(".sidebar-list li").children("a").on("click",function(){
    ...
    <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo U('Index/index');?>">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">财务日志</span></div>
        </div>
						...
						<form action="<?php echo U('Pay/index');?>" method="post">
							<table class="search-tab">
								<tr>
									...
									<th width="70">用户:</th>
									<td><input class="common-text" placeholder="用户" name="name" value="<?php echo ($get["name"]); ?>" id="" type="text"></td>
                                    <th width="70">用户ID:</th>
									<td><input class="common-text" placeholder="用户ID" name="member_id" value="<?php echo ($get["name"]); ?>" id="" type="text"></td>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            <td><?php echo ($vo["finance_id"]); ?></td>
                            <td><?php echo ($vo["username"]); ?></td>
                            <td><?php echo ($vo["typename"]); ?></td>
                            <td><?php echo ($vo["content"]); ?></td>
                            <td><?php echo ($vo["money"]); ?></td>
                            <td><?php echo ($vo["currency_name"]); ?></td>
							<td><?php if(($vo["money_type"]) == "1"): ?>收入<?php else: ?>支出<?php endif; ?></td>
...
function download(){
	...
	var url="<?php echo U('Finance/derivedExcel');?>";
