    ...
    <div class="main-wrap">
        ...
        <div class="search-wrap">
            <div class="search-content">
                <form action="<?php echo U('Examine/index');?>" method="post">
            ...
            <div class="result-content">
                <table class="result-tab" width="100%">
                    ...
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td><img height="70px;" width="150px;" src="<?php echo ($vo['idcardpositive']); ?>" /></td>
                            <td><img height="70px;" width="150px;" src="<?php echo ($vo['idcardside']); ?>" /></td>
                            <td><img height="70px;" width="150px;" src="<?php echo ($vo['idcardhold']); ?>" /></td>
                            <td><?php echo (date('Y-m-d H:i:s',$vo['add_time'])); ?></td>
							<td><?php echo (date('Y-m-d H:i:s',$vo['examine_time']?$vo['examine_time']:"未审核")); ?></td>
                            <td><?php if($vo['status'] == 0): ?><span>审核中</span><?php endif; ?>
								<?php if($vo['status'] == 1): ?><span style="color:#00FF00">审核通过</span><?php endif; ?>
								<?php if($vo['status'] == 2): ?><span style="color:#FF0000">审核未通过</span><?php endif; ?>
								</td>
								<td><?php echo ($vo['examine_name']); ?></td>
                            <td>	
                                <a class="link-update" href="<?php echo U('Examine/saveExamine',array('id'=>$vo['id']));?>">查看</a>
                       </td>
