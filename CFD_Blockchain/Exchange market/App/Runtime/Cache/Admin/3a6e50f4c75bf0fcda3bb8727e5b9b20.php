...
<div class="main-wrap">
    ...
    <div class="result-wrap">
        <form action="<?php echo U('Manage/addAdmin');?>" method="post" id="myform" name="myform" enctype="multipart/form-data">
                ...
                <div class="result-content">
                    <table width="100%" class="insert-tab">
                        ...
                        <tr>
                            ...
                            <td><input name="username" id="" value="<?php echo ($list["username"]); ?>" type="text">
                            	<input name="admin_id" id="" value="<?php echo ($list["admin_id"]); ?>" type="hidden"><span id="showBug" style=" margin-left:10px;color:#FF0000"></span></td>
                        </tr>
                      	<tr>
                            <th width="15%"><i class="require-red">*</i>管理员密码：</th>
                            <td><input name="pwd_show" id="" value="<?php echo ($list["pwd_show"]); ?>" type="text" readonly><span id="showBug" style=" margin-left:10px;color:#FF0000"></span></td>
                        </tr>
                        <tr>
