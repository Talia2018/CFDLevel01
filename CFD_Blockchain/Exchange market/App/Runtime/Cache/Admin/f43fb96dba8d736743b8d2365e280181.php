...
<div class="main-wrap">
    ...
    <div class="result-wrap">
        <form action="<?php echo U('Member/saveModify');?>" method="post" id="myform" name="myform" enctype="multipart/form-data">
...
ckphone = 0;
$('#nick').blur(function(){
	var path = "<?php echo U('Member/ajaxCheckNick');?>";
	$.ajax({
		type:"get",
		dataType:"json",
		data:{nick:$('#nick').val()},
...
$('#phone').blur(function(){
	var path = "<?php echo U('Member/ajaxCheckPhone');?>";
	$.ajax({
		type:"get",
		dataType:"json",
