...
//         if(IS_POST){
//         	if(empty($_POST['num'])){
//         		$this->error('Dividend value cannot be empty');
//         	}
//         	if(empty($_POST['currency_id'])){
//         		$this->error('Dividend currency cannot be empty');
//         	}
//         	if(empty($_POST['text'])){
//         		$this->error('Message reminder cannot be empty');
//         	}
//         	if(!is_numeric($_POST['num'])){
//         		$this->error('The dividend value is incorrect');
//         	}
//         	$num = $_POST['num']; //分红的份额
...
//         	if(empty($member)){
//         		$this->error('No number of people who need dividends');
//         	}
//         	foreach ($member as $v){
//         		$item[]=$v['member_id'];
//         	}
...
//         		$this -> addMessage_all($v['member_id'],-2,'Dividend bonus',$text);
//         	}
//         	$this ->success("Successful dividend");
//         }
//     }
    ...
    public function addBonus(){
    	if(IS_POST){
    		...
    		if(!isset($_POST['set_currency_id'])){
    			$this->error('The dividend base is incorrect');
    		}
